describe("Complex", function(){
  ...
  it("should return a complex number from a string or numbers", function(){
...
// On a new line, because z would become a new instance after the add method.
    var w = z.add(new Complex(3, 4));
    expect(z.toString()).toEqual("1+2i");
    expect(w.toString()).toEqual("4+6i");
  });

  it("should calculate the magnitude of a complex number", function(){
    expect(new Complex(3, 4).magnitude()).toEqual(5);
    expect(new Complex(3, 4).abs()).toEqual(5);
  });

  it("should calculate the angle between the real and the imaginary vectors", function(){
  ...
  it("should return the conjugate of a given complex number", function(){
  ...
  it("should multiply a complex number and a real number", function(){
  ...
  it("should divide a complex number by another complex number", function(){
  ...
  it("should do z^n, where z is complex and n is real", function(){
    expect(new Complex(1, 2).pow(2).toPrecision(1) + "").toEqual("-3+4i");
  });

  it("should do z^w, where z and w are complex", function(){
    var n = new Complex(1, 2).pow(new Complex(3, 4)).toPrecision(10).toString();
    expect(n).toEqual("0.1290095941+0.03392409291i");
  });

  it("should return the square root of the complex number", function(){
    var z = Complex.from("1+4i").sqrt().toPrecision(10).toString();
    expect(z).toEqual("1.600485180+1.249621068i");
  });


  it("should return the square root of the complex number with a negative real part", function(){
    var z = new Complex(-3, 4).sqrt().toString();
    expect(z).toEqual("1+2i");
  });

  it("should return the square root of a complex number with a negative imaginary part", function(){
    var z = new Complex(3, -4).sqrt().toString();
    expect(z).toEqual("2-i");
  });

  it("should return the square root of a complex number with both negative real and imaginary parts", function(){
    var z = new Complex(-3, -4).sqrt().toString();
    expect(z).toEqual("1-2i");
  });

  it("should return the natural logarithm of a complex number", function(){
  ...
  it("should return the exponential of a complex number", function(){
  ...
  it("should test if two complex numbers are equal", function(){
    expect(new Complex(2, 3).equals(new Complex(2, 3))).toBe(true);
    expect(new Complex(2, 3).equals(new Complex(2, 4))).toBe(false);
    expect(new Complex(2, 3).equals(new Complex(1, 3))).toBe(false);
  });
